/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=contact-worker/wrangler.jsonc contact-worker/worker-configuration.d.ts` (hash: 113778e0277f29eeafa5d5c6659b3cad)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "https://johnbieniek.com,https://www.johnbieniek.com,https://johns-portfolio.pages.dev,https://johns-portfolio-beta.pages.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "FROM_ADDRESS" | "TO_ADDRESS">> {}
}
